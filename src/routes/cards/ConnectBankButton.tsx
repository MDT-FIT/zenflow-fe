...
export const ConnectBankButton = ({ bank, subtitle, image, link }: ConnectBankButtonProps) => {
  ...
  return (
    <a
      ...
      className={cn("flex items-center gap-4 h-auto p-4 rounded-lg", "bg-[rgba(255,255,255,0.05)] hover:bg-[rgba(255,255,255,0.1)] transition hover:scale-101", { "opacity-50 cursor-not-allowed **pointer-events-none**": isDisabled})}
    >
