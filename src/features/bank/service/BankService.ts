...
export class BankService {
     ...
     * @throws ApiError
     */
    public static getApiBankBankConfigs(
        userId: string,
     ...
     * @throws ApiError
     */
    public static postApiBankStatsTopCard(
        requestBody?: StatsFilterDto,
    ): CancelablePromise<any> {
        return __request(OpenAPI, {
            method: 'POST',
     ...
     * @throws ApiError
     */
    public static postApiBankConnectOtherBank(
        code: string,
        userId?: string,
    ): CancelablePromise<any> {
        return __request(OpenAPI, {
     ...
     * @throws ApiError
     */
    public static postApiBank(
        requestBody?: BankConfigDto,
    ): CancelablePromise<BankConfigDto> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/Bank',
            body: requestBody,
